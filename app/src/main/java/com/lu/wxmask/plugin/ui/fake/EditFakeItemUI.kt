...
class EditFakeItemUI(
    private val context: Context,
    private val lst: MutableList<FakeItemBean>,
    ...
    private var onConfigChangeListener: ((DialogInterface, FakeItemBean, Int) -> Unit)? = null
    private var onFreeButtonListener: DialogInterface.OnClickListener? = null

    private var freeButtonText: CharSequence? = null

    fun setOnConfigChangeListener(listener: (dialog: DialogInterface, mask: FakeItemBean, mode: Int) -> Unit): EditFakeItemUI {
        onConfigChangeListener = listener
        return this
    }

    fun setOnDismissListener(listener: DialogInterface.OnDismissListener): EditFakeItemUI {
        onDismissListener = listener
        return this
    }

    fun setFreeButton(text: CharSequence, listener: DialogInterface.OnClickListener?): EditFakeItemUI {
        freeButtonText = text
    ...
    fun show() {
        ...
        val ui = FakeItemUIController(context, fakeItemBean)
        ...
        AlertDialog.Builder(context)
            ...
            .also { dialog ->
                ...
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                    ...
                    if (fakeId.isNotEmpty() && fakeId != fakeItemBean.fakeId && FakeUtil.checkExitFakeId(lst, fakeId)) {
