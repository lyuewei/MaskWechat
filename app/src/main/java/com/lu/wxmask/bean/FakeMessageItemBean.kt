...
class FakeMessageItemBean(
    ...
    constructor(fakeId: String):this(fakeId,Constrant.WX_FAKE_TYPE_ADD,(System.currentTimeMillis()/1000),System.currentTimeMillis(),"","",false,true)
    companion object {
